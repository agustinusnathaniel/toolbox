...
describe('calculateChargingEstimate within 80% zone', () => {
...
describe('calculateChargingEstimate across 80% threshold', () => {
...
describe('calculateChargingEstimate above 80% zone', () => {
...
describe('calculateChargingEstimate all charger types', () => {
  test.each([
    ['ac-l1', 36.14],
    ['ac-l2', 34.88],
    ['dc-fast', 34.48],
