...
export async function getRouter() {
  const router = createRouter({
    ...
    // Keep search values as strings. The default parseSearchWith(JSON.parse)
    // coerces `?count=3` to the number 3, which fails every tool's z.string()
    // search schema and triggers the error boundary (see search-params.ts).
